export default {
    ...
    computed: {
        ...
        badge_color_style() {
            if (this.section == "Core losses") {
                return "background-color: SlateGrey; color: black";
            }
            else if (this.section == "Gap Reluctance") {
                return "background-color: MediumAquaMarine; color: black";
            }
    ...
    template: `             
        <div class="col-md-6 col-lg-4 col-xl-3 d-flex align-items-stretch">
            <div class="card mt-4 box-shadow bg-primary">
